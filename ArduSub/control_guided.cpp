...
static Vector3d posvel_pos_target_cm;
...
bool Sub::guided_set_destination_posvel(const Vector3f& destination, const Vector3f& velocity)
{
    ...
    posvel_pos_target_cm = destination.todouble();
    posvel_vel_target_cms = velocity;

    pos_control.input_pos_vel_accel_xy(posvel_pos_target_cm, posvel_vel_target_cms, Vector3f());
    Vector3f targetf = posvel_pos_target_cm.tofloat();
    pos_control.input_pos_vel_accel_z(targetf, posvel_vel_target_cms, Vector3f());
    posvel_pos_target_cm.z = targetf.z;
...
void Sub::guided_posvel_control_run()
{
    ...
    posvel_pos_target_cm += (posvel_vel_target_cms * pos_control.get_dt()).todouble();
