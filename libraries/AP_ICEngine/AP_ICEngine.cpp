...
const AP_Param::GroupInfo AP_ICEngine::var_info[] = {
    ...
    // @Description: This is an RC input channel for requesting engine start. Engine will try to start when channel is above 1700. Engine will stop when channel is below 1300.
    // @User: Standard
    ...
    AP_GROUPINFO("RPM_CHAN",  9, AP_ICEngine, rpm_instance, 1),
...
// constructor
AP_ICEngine::AP_ICEngine(AP_RPM &_rpm) :
    rpm(_rpm),
    state(ICE_OFF)
{
