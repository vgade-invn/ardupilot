...
void NavEKF3_core::LogCovariances()
{
    if (core_index !=0 ) {
        return;
    }
    ...
    AP::logger().Write("SVAA",
                       ...
                       "Qfffffffffffffff",
                        time_us,
                        (double)statesArray[0],
                        (double)statesArray[1],
                        (double)statesArray[2],
                        (double)statesArray[3],
                        ...
                        (double)statesArray[12],
                        (double)statesArray[13],
                        (double)statesArray[14]);
    AP::logger().Write("SVAB",
                       "TimeUS,15,16,17,18,19,20,21,22,23",
                       "Qfffffffff",
                        time_us,
                        (double)statesArray[15],
                        (double)statesArray[16],
                        (double)statesArray[17],
                        (double)statesArray[18],
                        (double)statesArray[19],
                        (double)statesArray[20],
                        (double)statesArray[21],
                        (double)statesArray[22],
                        (double)statesArray[23]);

    // log diagonals
    Log_Write_State_Variances(time_us);

    // log off diagonals
    AP::logger().Write("CVAA",
