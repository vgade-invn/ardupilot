...
private:
    ...
    static uint8_t get_pin_channel(uint8_t index, uint8_t pin);
    static uint8_t get_pin_channel_with_offset(uint8_t index, uint8_t pin);
    static float get_pin_scaling(uint8_t index, uint8_t pin);
