#!/usr/bin/env python
'''
map pin name and function to a STM32 alternate function number
'''
import sys
...
af_maps = { "STM32F412Rx" : AltFunction_map_F412,
            "STM32F427xx" : AltFunction_map_F427 }

def get_alt_function(mcu, pin, function):
    '''return alternative function number for a pin'''
    if not mcu in af_maps:
        print("Unknown mcu %s in get_alt_function" % mcu)
        sys.exit(1)
