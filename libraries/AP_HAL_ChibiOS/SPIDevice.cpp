...
#define SPIDEV_CS_MS5611           GPIOD, 7
#define SPIDEV_CS_MPU              GPIOC, 2
#define SPIDEV_CS_LSM9DS0_G        GPIOC, 13
#define SPIDEV_CS_LSM9DS0_AM       GPIOC, 15
#define SPIDEV_CS_RAMTRON          GPIOD, 10
    
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_CHIBIOS_SKYVIPER_V2450
#define SPI_BUS_SENSORS 0
#define SPI_BUS_SENSORS2 1
#define SPI_BUS_EXT 2
...
SPIDesc SPIDeviceManager::device_table[] = {
    ...
    SPIDesc("cc2500",  SPI_BUS_RADIO, SPIDEV_CYRF, SPIDEV_CS_RADIO, SPIDEV_MODE0, 4*MHZ, 4*MHZ),
    ...
    SPIDesc("lsm9ds0_g", SPI_BUS_SENSORS, SPIDEV_EXT_LSM9DS0_G , SPIDEV_CS_LSM9DS0_G, SPIDEV_MODE3, 11*MHZ, 11*MHZ ),
    SPIDesc("lsm9ds0_am", SPI_BUS_SENSORS, SPIDEV_EXT_LSM9DS0_AM , SPIDEV_CS_LSM9DS0_AM, SPIDEV_MODE3, 11*MHZ, 11*MHZ ),
    SPIDesc("ramtron", SPI_BUS_RAMTRON, SPIDEV_RAMTROM, SPIDEV_CS_RAMTRON, SPIDEV_MODE3, 8*MHZ, 8*MHZ ),
#elif CONFIG_HAL_BOARD_SUBTYPE == HAL_BOARD_SUBTYPE_CHIBIOS_SKYVIPER_V2450
    ...
    SPIDesc("cc2500",  SPI_BUS_SENSORS2, SPIDEV_CYRF, SPIDEV_CS_CYRF, SPIDEV_MODE0, 4*MHZ, 4*MHZ),
