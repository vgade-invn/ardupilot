...
void AP_InertialSensor::BatchSampler::init()
{
    ...
    GCS_SEND_TEXT(MAV_SEVERITY_DEBUG, "INS: alloc %u bytes for ISB (free=%u)", (unsigned int)3*_required_count*sizeof(uint16_t), (unsigned int)hal.util->available_memory());
