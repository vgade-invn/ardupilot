...
AP_InertialSensor::detect_backends(void)
{
    ...
    if (AP_BoardConfig::get_board_type() == AP_BoardConfig::PX4_BOARD_PX4V1) {
        ...
        if (!_add_backend(AP_InertialSensor_MPU6000::probe(*this, hal.spi->get_device(HAL_INS_MPU60x0_NAME), ROTATION_YAW_270))) {
            // could be a 9250 on a pixfalcon
        ...
        _add_backend(AP_InertialSensor_LSM9DS0::probe(*this,
                                                      ...
                                                      ROTATION_NONE, ROTATION_YAW_270));
        ...
        _add_backend(AP_InertialSensor_LSM9DS0::probe(*this,
                                                      ...
                                                      ROTATION_YAW_270, ROTATION_YAW_90));
        ...
        _add_backend(AP_InertialSensor_MPU6000::probe(*this, hal.spi->get_device(HAL_INS_ICM20608_NAME), ROTATION_NONE));
        _add_backend(AP_InertialSensor_MPU9250::probe(*this, hal.spi->get_device(HAL_INS_MPU9250_NAME), ROTATION_NONE));
