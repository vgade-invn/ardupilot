...
//      TODO: TYPE_HELICAL,
    ...
    bool use_thr_min_during_flare(void); //defaults to false, but _options bit zero enables it.
...
private:
    ...
    AP_Int32 _options;    // user-configurable bitmask options, via a parameter, for landing
