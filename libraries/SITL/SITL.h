...
public:
    ...
    AP_Vector3f mag_gnd;  // ground level magnetic anomally in mag units
    AP_Float mag_gnd_hgt; // height at which mag_gnd has reduced to 1/8 of the magnitude at ground level
