...
const AP_Param::GroupInfo SITL::var_info3[] = {
    ...
    AP_GROUPINFO("ARSPD2_PITOT",  60, SITL,  arspd2_fail_pitot_pressure, 0),
...
const AP_Param::GroupInfo SITL::var_gps[] = {
    ...
    AP_GROUPINFO("GPS_VERR",      14, SITL,  gps_vel_err[0], 0),
    ...
    AP_GROUPINFO("GPS2_VERR",     43, SITL,  gps_vel_err[1], 0),
