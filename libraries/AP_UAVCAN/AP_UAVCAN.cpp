...
void AP_UAVCAN::init(uint8_t driver_num)
{
    ...
    start_res = gnss_fix->start(gnss_fix_cb_arr[driver_num]);
    ...
    start_res = gnss_aux->start(gnss_aux_cb_arr[driver_num]);
    ...
    start_res = magnetic->start(magnetic_cb_arr[driver_num]);
    ...
    start_res = magnetic2->start(magnetic_cb_2_arr[driver_num]);
    ...
    start_res = air_data_sp->start(air_data_sp_cb_arr[driver_num]);
    ...
    start_res = air_data_st->start(air_data_st_cb_arr[driver_num]);
    ...
    start_res = battery_info_st->start(battery_info_st_cb_arr[driver_num]);
    ...
    act_out_array[driver_num] = new uavcan::Publisher<uavcan::equipment::actuator::ArrayCommand>(*_node);
    ...
    esc_raw[driver_num] = new uavcan::Publisher<uavcan::equipment::esc::RawCommand>(*_node);
    ...
    rgb_led[driver_num] = new uavcan::Publisher<uavcan::equipment::indication::LightsCommand>(*_node);
