...
const AP_Param::GroupInfo AP_CANManager::CANDriver_Params::var_info[] = {
    ...
    // @Values{Copter,Plane,Sub}: 0:Disabled,1:UAVCAN,2:KDECAN,3:ToshibaCAN,4:PiccoloCAN,5:TestCAN
    // @Values: 0:Disabled,1:UAVCAN,3:ToshibaCAN,4:PiccoloCAN,5:TestCAN
    // @User: Advanced
    // @RebootRequired: True
