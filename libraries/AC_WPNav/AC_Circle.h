...
public:
    ...
    void init(const Vector3d& center, bool terrain_alt);
    ...
    void set_center(const Vector3f& center, bool terrain_alt) { _center = center.todouble(); _terrain_alt = terrain_alt; }

    /// get_circle_center in cm from home
    const Vector3d& get_center() const { return _center; }
...
private:
    ...
    // internal variables
    Vector3d    _center;        // center of circle in cm from home
