...
MAV_MISSION_RESULT AP_Mission::mavlink_int_to_mission_cmd(const mavlink_mission_item_int_t& packet, AP_Mission::Mission_Command& cmd)
{
    ...
    case MAV_CMD_NAV_SCRIPTING:
        cmd.content.nav_scripting.command = packet.param1;
        cmd.content.nav_scripting.timeout_s = packet.param2;
        cmd.content.nav_scripting.arg1 = packet.param3;
        cmd.content.nav_scripting.arg2 = packet.param4;
        break;
...
bool AP_Mission::mission_cmd_to_mavlink_int(const AP_Mission::Mission_Command& cmd, mavlink_mission_item_int_t& packet)
{
    ...
    case MAV_CMD_NAV_SCRIPTING:
        packet.param1 = cmd.content.nav_scripting.command;
        packet.param2 = cmd.content.nav_scripting.timeout_s;
        packet.param3 = cmd.content.nav_scripting.arg1;
        packet.param4 = cmd.content.nav_scripting.arg2;
        break;
