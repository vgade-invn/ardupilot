...
--[[
  // @Param: GEN_SVF_ENABLE
  // @DisplayName: Generator SVFFI enable
  // @Description: Enable SVFFI generator support
  // @Values: 0:Disabled,1:Enabled
  // @User: Standard
--]]
GEN_SVF_ENABLE = bind_add_param("ENABLE", 1, 0)

if GEN_SVF_ENABLE:get() ~= 1 then
   return
end
...
local function check_input()
   ...
   local crc2 = get_crc16(string.sub(s,1,n_bytes-2))
   if crc ~= crc2 then
...
local function update_EFI()
   ...
   cylinder_state:cylinder_head_temperature(math.max(state.cht1,state.cht2))
   ...
   gcs:send_named_float('GEN_FUEL', state.fuellevel)
