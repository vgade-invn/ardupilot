...
#define AP_SERIAL_EXTENSION_ENABLED (!HAL_MINIMIZE_FEATURES && BOARD_FLASH_SIZE > 1024)
#endif

#ifndef HAL_ENABLE_SERIAL_TUNNEL
#define HAL_ENABLE_SERIAL_TUNNEL AP_SERIAL_EXTENSION_ENABLED
#endif

#ifndef HAL_CANARD_BROADCAST_THREAD_SAFE
#define HAL_CANARD_BROADCAST_THREAD_SAFE HAL_ENABLE_SERIAL_TUNNEL
#endif
