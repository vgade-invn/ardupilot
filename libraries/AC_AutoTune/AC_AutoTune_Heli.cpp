...
void AC_AutoTune_Heli::test_run(const float dir_sign)
{
...
void AC_AutoTune_Heli::updating_rate_p_down_all(uint8_t test_axis)
{
...
void AC_AutoTune_Heli::updating_rate_d_down_all(uint8_t test_axis)
{
    switch (test_axis) {
    case ROLL:
        updating_rate_d_down(tune_roll_rd);
        break;
    case PITCH:
        updating_rate_d_down(tune_pitch_rd);
        break;
    case YAW:
        updating_rate_d_down(tune_yaw_rd);
        break;
    }
}
...
void AC_AutoTune_Heli::updating_rate_ff_down_all(uint8_t test_axis)
{
...
void AC_AutoTune_Heli::updating_angle_p_down_all(uint8_t test_axis)
{
    switch (test_axis) {
    case ROLL:
        updating_angle_p_down(tune_roll_sp);
        break;
    case PITCH:
        updating_angle_p_down(tune_pitch_sp);
        break;
    case YAW:
        updating_angle_p_down(tune_yaw_sp);
        break;
    }
}
...
void AC_AutoTune_Heli::updating_rate_d_down(float &tune_d)
{
...
void AC_AutoTune_Heli::updating_angle_p_down(float &tune_p)
{
