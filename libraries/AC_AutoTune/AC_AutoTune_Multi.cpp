...
void AC_AutoTune_Multi::updating_rate_p_down_all(uint8_t test_axis)
{
...
void AC_AutoTune_Multi::updating_rate_ff_up_all(uint8_t test_axis)
{

}

void AC_AutoTune_Multi::updating_rate_ff_down_all(uint8_t test_axis)
{
...
void AC_AutoTune_Multi::updating_max_gains_all(uint8_t test_axis)
{
