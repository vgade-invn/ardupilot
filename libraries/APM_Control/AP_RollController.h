...
private:
    ...
    float _last_pid_info_D = 0.0f;          // value of the D term (angular rate control feedback) from the previous time step (deg)
    ...
    float _slew_rate_amplitude = 0.0f;      // Amplitude of the servo slew rate produced by the angular rate feedback (deg/sec)
