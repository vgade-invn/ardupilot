...
# include USERHOOK_VARIABLES
 ...
 #define MOTOR_CLASS AP_MotorsMulticopter
    ...
    void mavlink_motor_test_start(mavlink_channel_t chan, uint8_t motor_seq, uint8_t throttle_type, uint16_t throttle_value, float timeout_sec, uint8_t motor_count);
