...
void Plane::calc_nav_roll()
{
    ...
    if ((control_mode == GUIDED || control_mode == AVOID_ADSB) &&
    ...
    } else if (control_mode == GUIDED && guided_state.target_heading_type != GUIDED_HEADING_NONE) {
        ...
        g2.guidedHeading.set_input_filter_all(error);
        g2.guidedHeading.set_dt(delta);

        float i = g2.guidedHeading.get_integrator();
