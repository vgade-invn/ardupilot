 ...
 */
const uint8_t AP_Tuning_Plane::tuning_set_q_rate_roll_pitch[] = { TUNING_Q_RATE_ROLL_KPI, TUNING_Q_RATE_ROLL_KD,
                                                                  TUNING_Q_RATE_PITCH_KPI, TUNING_Q_RATE_PITCH_KD};
const uint8_t AP_Tuning_Plane::tuning_set_q_rate_roll[] =       { TUNING_Q_RATE_ROLL_KPI, TUNING_Q_RATE_ROLL_KD };
const uint8_t AP_Tuning_Plane::tuning_set_q_rate_pitch[] =      { TUNING_Q_RATE_PITCH_KPI, TUNING_Q_RATE_PITCH_KD };
