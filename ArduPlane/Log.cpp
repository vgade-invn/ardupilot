...
void Plane::Log_Write_Precland()
{
    ...
    g2.precland.get_target_position_relative_cm(target_pos_rel);
    g2.precland.get_target_velocity_relative_cms(target_vel_rel);
    ...
    struct log_Precland pkt = {
        ...
        last_meas       : g2.precland.last_backend_los_meas_ms(),
