...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Bitmask: 0:Rudder mixing in direct flight modes only (Manual / Stabilize / Acro),1:Use centered throttle in Cruise or FBWB to indicate trim airspeed, 2:Disable attitude check for takeoff arming, 3:Force target airspeed to trim airspeed in Cruise or FBWB, 4:Use THR_MIN instead of zero throttle when armed, 5:Use takeoff waypoint location
    // @User: Advanced
